...
<div class="container mt-10">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header" style="background:#739F79; color:white">Crear empresa</div>
           

            <div class="card-body">
                <form method="POST" action="{{ route('empresa.save')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="cuit" type="text" name="cuit" class="form-control" required/>
                        @if($errors->has('cuit'))
                           <span class="invalid-feedback" role="alert">
